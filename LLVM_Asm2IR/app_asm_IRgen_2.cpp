...
int main(int argc, char *argv[]) {
  ...
  for (const auto &func : func_PC) {
    ...
    for (RegVal_t PC = func.second; PC < Instructions.size(); ++PC) {
      ...
      /*
      // IR implementation for PUT_PIXELS_14 instruction
      if (Instructions[PC]->m_ID == PUT_PIXELS_14) {
        continue;
      }
      */

      /*
      // IR implementation for FLUSH instruction
      if (Instructions[PC]->m_ID == FLUSH) {
        continue;
      }
      */
      ...
      /*
      // IR implementation for RAND instruction
      if (Instructions[PC]->m_ID == RAND) {
        continue;
      }
      */


      // IR implementation for MV instruction
      if (Instructions[PC]->m_ID == MV) {
        // arg1
      ...
      // IR implementation for MVI instruction
      if (Instructions[PC]->m_ID == MVI) {
        // arg1
        Value *arg1_p = builder.CreateConstGEP2_64(regFileType, regFile, 0, Instructions[PC]->m_rs1);
      ...
      if (Instructions[PC]->m_ID == ALLOCA) {
          ...
          Type *arrayType = ArrayType::get(builder.getInt64Ty(), Instructions[PC]->m_imm);
          Value *alloca = builder.CreateAlloca(arrayType);
          builder.CreateStore(alloca, arg1_p);
          continue;
      }
      ...
      if (Instructions[PC]->m_ID == ADD) {
          ...
          Value *arg2_p = builder.CreateConstGEP2_64(regFileType, regFile, 0, Instructions[PC]->m_rs2);
          // arg3
          Value *arg3_p = builder.CreateConstGEP2_64(regFileType, regFile, 0, Instructions[PC]->m_rs3);
          Value *add_arg1_arg2 = builder.CreateAdd(builder.CreateLoad(builder.getInt64Ty(), arg2_p),
                                                    builder.CreateLoad(builder.getInt64Ty(), arg3_p));
          builder.CreateStore(add_arg1_arg2, arg1_p);
          continue;
      }

      // IR implementation for SUB instruction
      if (Instructions[PC]->m_ID == SUB) {
          // arg1
          Value *arg1_p = builder.CreateConstGEP2_64(regFileType, regFile, 0, Instructions[PC]->m_rs1);
          // arg2
          Value *arg2_p = builder.CreateConstGEP2_64(regFileType, regFile, 0, Instructions[PC]->m_rs2);
          // arg3
          Value *arg3_p = builder.CreateConstGEP2_64(regFileType, regFile, 0, Instructions[PC]->m_rs3);
          Value *sub_arg1_arg2 = builder.CreateSub(builder.CreateLoad(builder.getInt64Ty(), arg2_p),
                                                    builder.CreateLoad(builder.getInt64Ty(), arg3_p));
          builder.CreateStore(sub_arg1_arg2, arg1_p);
          continue;
      }

      // IR implementation for DIV instruction
      if (Instructions[PC]->m_ID == DIV) {
          // arg1
          Value *arg1_p = builder.CreateConstGEP2_64(regFileType, regFile, 0, Instructions[PC]->m_rs1);
          // arg2
          Value *arg2_p = builder.CreateConstGEP2_64(regFileType, regFile, 0, Instructions[PC]->m_rs2);
          // arg3
          Value *arg3_p = builder.CreateConstGEP2_64(regFileType, regFile, 0, Instructions[PC]->m_rs3);
          Value *div_arg1_arg2 = builder.CreateUDiv(builder.CreateLoad(builder.getInt64Ty(), arg2_p),
                                                    builder.CreateLoad(builder.getInt64Ty(), arg3_p));
          builder.CreateStore(div_arg1_arg2, arg1_p);
          continue;
      }
      ...
      if (Instructions[PC]->m_ID == OR) {
          ...
          // arg3
          Value *arg3_p = builder.CreateConstGEP2_64(regFileType, regFile, 0, Instructions[PC]->m_rs3);
          Value *or_arg1_arg2 = builder.CreateOr(builder.CreateLoad(builder.getInt64Ty(), arg2_p),
                                                    builder.CreateLoad(builder.getInt64Ty(), arg3_p));
          builder.CreateStore(or_arg1_arg2, arg1_p);
          continue;
      }
      ...
      if (Instructions[PC]->m_ID == ADDI) {
          ...
          Value *arg2_p = builder.CreateConstGEP2_64(regFileType, regFile, 0, Instructions[PC]->m_rs2);
          // arg3
          Value *arg3 = builder.getInt64(Instructions[PC]->m_imm);
          Value *add_arg1_arg2 = builder.CreateAdd(builder.CreateLoad(builder.getInt64Ty(), arg2_p), arg3);
          builder.CreateStore(add_arg1_arg2, arg1_p);
          continue;
      }
      ...
      if (Instructions[PC]->m_ID == MULI) {
          ...
          // arg3
          Value *arg3 = builder.getInt64(Instructions[PC]->m_imm);
          Value *mul_arg1_arg2 = builder.CreateMul(builder.CreateLoad(builder.getInt64Ty(), arg2_p), arg3);
          builder.CreateStore(mul_arg1_arg2, arg1_p);
          continue;
      }

      // IR implementation for REMI instruction
      if (Instructions[PC]->m_ID == REMI) {
          // arg1
          Value *arg1_p = builder.CreateConstGEP2_64(regFileType, regFile, 0, Instructions[PC]->m_rs1);
          // arg2
          Value *arg2_p = builder.CreateConstGEP2_64(regFileType, regFile, 0, Instructions[PC]->m_rs2);
          // arg3
          Value *arg3 = builder.getInt64(Instructions[PC]->m_imm);
          Value *rem_arg1_arg2 = builder.CreateURem(builder.CreateLoad(builder.getInt64Ty(), arg2_p), arg3);
          builder.CreateStore(rem_arg1_arg2, arg1_p);
          continue;
      }

      // IR implementation for ANDI instruction
      if (Instructions[PC]->m_ID == ANDI) {
          ...
          // arg3
          Value *arg3 = builder.getInt64(Instructions[PC]->m_imm);
          Value *and_arg1_arg2 = builder.CreateAnd(builder.CreateLoad(builder.getInt64Ty(), arg2_p), arg3);
          builder.CreateStore(and_arg1_arg2, arg1_p);
          continue;
      }

      // IR implementation for SLI instruction
      if (Instructions[PC]->m_ID == SLI) {
          // arg1
          Value *arg1_p = builder.CreateConstGEP2_64(regFileType, regFile, 0, Instructions[PC]->m_rs1);
          // arg2
          Value *arg2_p = builder.CreateConstGEP2_64(regFileType, regFile, 0, Instructions[PC]->m_rs2);
          // arg3
          Value *arg3 = builder.getInt64(Instructions[PC]->m_imm);
          Value *shl_arg1_arg2 = builder.CreateShl(builder.CreateLoad(builder.getInt64Ty(), arg2_p), arg3);
          builder.CreateStore(shl_arg1_arg2, arg1_p);
          continue;
      }
      ...
      if (Instructions[PC]->m_ID == LOAD) {
          ...
          Value *ptr = builder.CreateInBoundsGEP(builder.getInt64Ty(),
                                                  builder.CreateLoad(builder.getInt64Ty()->getPointerTo(), arg2_p),
                                                  builder.CreateLoad(builder.getInt64Ty(), arg3_p));
          Value *loaded = builder.CreateLoad(builder.getInt64Ty(), ptr);
          builder.CreateStore(loaded, arg1_p);
          continue;
      }
      ...
      if (Instructions[PC]->m_ID == STORE) {
          ...
          Value *ptr = builder.CreateInBoundsGEP(builder.getInt64Ty(),
                                                  builder.CreateLoad(builder.getInt64Ty()->getPointerTo(), arg2_p),
                                                  builder.CreateLoad(builder.getInt64Ty(), arg3_p));
          Value *stored = builder.CreateLoad(builder.getInt64Ty(), arg1_p);
          builder.CreateStore(stored, ptr);
          continue;
      }

      // IR implementation for ICMPGE instruction
      if (Instructions[PC]->m_ID == ICMPGE) {
          // arg1
          Value *arg1_p = builder.CreateConstGEP2_64(regFileType, regFile, 0, Instructions[PC]->m_rs1);
          // arg2
          Value *arg2_p = builder.CreateConstGEP2_64(regFileType, regFile, 0, Instructions[PC]->m_rs2);
          // arg3
          Value *arg3_p = builder.CreateConstGEP2_64(regFileType, regFile, 0, Instructions[PC]->m_rs3);
          Value *comp = builder.CreateICmpUGE(builder.CreateLoad(builder.getInt64Ty(), arg2_p),
                                              builder.CreateLoad(builder.getInt64Ty(), arg3_p));
          builder.CreateStore(builder.CreateZExt(comp, builder.getInt64Ty()), arg1_p);
          continue;
      }

      // IR implementation for ICMPNE instruction
      if (Instructions[PC]->m_ID == ICMPNE) {
          // arg1
          Value *arg1_p = builder.CreateConstGEP2_64(regFileType, regFile, 0, Instructions[PC]->m_rs1);
          // arg2
          Value *arg2_p = builder.CreateConstGEP2_64(regFileType, regFile, 0, Instructions[PC]->m_rs2);
          // arg3
          Value *arg3_p = builder.CreateConstGEP2_64(regFileType, regFile, 0, Instructions[PC]->m_rs3);
          Value *comp = builder.CreateICmpNE(builder.CreateLoad(builder.getInt64Ty(), arg2_p),
                                              builder.CreateLoad(builder.getInt64Ty(), arg3_p));
          builder.CreateStore(builder.CreateZExt(comp, builder.getInt64Ty()), arg1_p);
          continue;
      }
