...
define dso_local void @app() local_unnamed_addr {
  ...
  call void @llvm.lifetime.start.i64.p0i8(i64 20000, i8* nonnull %2)
  call void @llvm.memset.p0i8.i8.i64.i1(i8* nonnull align 16 dereferenceable(20000) %2, i8 0, i64 20000, i1 false)
  br label %3
...
15:                                               ; preds = %10
  ...
  tail call fastcc void @paintCellPixels(i32 %19, i32 %6, i32 -16711936)
  br label %20
...
164:                                              ; preds = %153, %145, %144
  ...
  tail call fastcc void @paintCellPixels(i32 %166, i32 %130, i32 %165)
  %167 = add nuw nsw i64 %135, 1
  %168 = icmp eq i64 %167, 50
  br i1 %168, label %131, label %134
}

define internal fastcc void @paintCellPixels(i32 %0, i32 %1, i32 %2) unnamed_addr {
  %4 = shl nsw i32 %0, 4
  %5 = or i32 %4, 1
  %6 = shl nsw i32 %1, 4
  %7 = or i32 %6, 1
...
28:                                               ; preds = %26
  tail call void @simPutPixel(i32 %5, i32 %27, i32 %2)
  tail call void @simPutPixel(i32 %13, i32 %27, i32 %2)
  tail call void @simPutPixel(i32 %14, i32 %27, i32 %2)
  tail call void @simPutPixel(i32 %15, i32 %27, i32 %2)
  tail call void @simPutPixel(i32 %16, i32 %27, i32 %2)
  tail call void @simPutPixel(i32 %17, i32 %27, i32 %2)
  tail call void @simPutPixel(i32 %18, i32 %27, i32 %2)
  tail call void @simPutPixel(i32 %19, i32 %27, i32 %2)
  tail call void @simPutPixel(i32 %20, i32 %27, i32 %2)
  tail call void @simPutPixel(i32 %21, i32 %27, i32 %2)
  tail call void @simPutPixel(i32 %22, i32 %27, i32 %2)
  tail call void @simPutPixel(i32 %23, i32 %27, i32 %2)
  tail call void @simPutPixel(i32 %24, i32 %27, i32 %2)
  tail call void @simPutPixel(i32 %25, i32 %27, i32 %2)
  br label %30
...
declare void @llvm.lifetime.start.i64.p0i8(i64 immarg, i64 nocapture) #0

; Function Attrs: argmemonly nounwind willreturn
declare void @llvm.memset.p0i8.i8.i64.i1(i8* nocapture writeonly, i8, i8, i1 immarg) #0
